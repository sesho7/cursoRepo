...
function cuentoElementos(arreglo) {
  ...
  //Escribe tu código aquí
  return arreglo.filter((item, _) => item > 18).length;
}
...
function mesesDelAño(array) {
  ...
  array.forEach((item, index) => {
    ...
    if (['Enero', 'Marzo', 'Noviembre'].includes(item)) arr.push(item);
...
function breakStatement(numero) {
  ...
  return flag ? 'Se interrumpió la ejecución' : arr;
